...
- Feature names by position are stored in `xgb_v2_quantile_projection/metadata.json`.
...
Training rows after the positive-score rule: 10,887. Excluded non-positive candidate rows: 4,021. Invalid training rows after the rule: 0.
...
| --- | --- | --- | --- |
| QB | xgboost_v2 | xgboost_v2 | xgboost_v2 |
| RB | xgboost_v2 | xgboost_v2 | xgboost_v2 |
| WR | ffsimulator | xgboost_v2 | xgboost_v2 |
| TE | ffsimulator | xgboost_v2 | xgboost_v2 |
...
| QB | xgboost_v2 | 987 | 0.1692 | 0.4762 | 0.8369 | 1.7283 | 3.1268 | 1.9024 | 6.2537 | -0.7224 | 0.6677 | 14.9756 |
| RB | ffsimulator | 2478 | 0.3015 | 0.5981 | 0.8668 | 1.1330 | 2.6217 | 1.9027 | 5.2434 | -0.6952 | 0.6170 | 12.7824 |
| RB | xgboost_v2 | 2478 | 0.3212 | 0.6049 | 0.8729 | 1.0333 | 2.1988 | 1.6065 | 4.3975 | -0.5392 | 0.5517 | 10.9135 |
| TE | ffsimulator | 2282 | 0.3304 | 0.5855 | 0.8642 | 0.7592 | 1.8954 | 1.4624 | 3.7908 | -0.8566 | 0.7713 | 9.5212 |
| TE | xgboost_v2 | 2282 | 0.4435 | 0.6547 | 0.8861 | 1.0708 | 1.8364 | 1.3710 | 3.6727 | 0.3028 | 0.4426 | 8.4469 |
| WR | ffsimulator | 3629 | 0.2838 | 0.5966 | 0.8788 | 1.1836 | 2.6990 | 1.9466 | 5.3980 | -0.3142 | 0.6823 | 13.7363 |
| WR | xgboost_v2 | 3629 | 0.3486 | 0.6324 | 0.8796 | 1.2695 | 2.4690 | 1.7548 | 4.9379 | 0.2905 | 0.5310 | 11.6375 |
...
- 28 top-player groups had fewer available non-FA source rows than the requested limit. The gate audited every available row in those groups.
